...
use fastapi_ai::core::database::Database;
use fastapi_ai::core::env::Env;
use fastapi_ai::core::instrumentation::init_observability;
use fastapi_ai::repository::openai::greeting::GreetingRepoOpenAI;
use fastapi_ai::services::greeting::GreetingService;
use fastapi_ai::{AppState, build_router};
