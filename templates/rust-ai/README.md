...
| `moon run fastapi-ai:dev`                            | Start FastAPI development server with hot reload on port {{ port_number }}          |
| `moon run fastapi-ai:start`                          | Launch FastAPI production server on port {{ port_number }}                          |
